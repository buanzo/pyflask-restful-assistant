...
class Syslog(FAXPlugin):
    author = 'Arturo Busleiman <buanzo@buanzo.com.ar>'
    description = 'Adds local syslog support to your application'
    ...
    def getImportLine(self):
        ...
        u = l.upper()
        rs = 'from {}.{}_syslog import {}Syslog'.format(l, l, u)
    ...
    def render(self):
        ...
        path = '{}/'.format(lb)
        fn = '{}_syslog.py'.format(lb)
        output = self.api.render(template='syslog.tpl',
                                 variables=vars)
